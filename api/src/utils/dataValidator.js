...
export const promotionValidator = [
    ...
    body('startDate').notEmpty().withMessage('Phải có đủ thời gian bắt đầu và kết thúc khuyến mãi'),
    body('endDate').notEmpty().withMessage('Phải có đủ thời gian bắt đầu và kết thúc khuyến mãi'),
]
